        ...
        <div class="main">
            <div class="right_side">
                  ...
                  <div class="main_title">
                        <h1>Welcome to FlexEase</h1>
                        <p> Sign up to continue managing your payments effortlessly.</p>
                  </div>
                  <div class="links">
            ...
            <div class="left_side mt-10">
                <div class="head">
                    <h1>Creat an Account</h1>
                    {{-- <p>Aleady have an account? <a href="">Login</a></p> --}}
                ...
                <form method="POST" action="{{ route('register') }}" class="form">
                    ...
                    <x-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" placeholder="First Name" :value="old('first_name')" required autofocus autocomplete="first_name" />
                    ...
                    <x-input id="email" class="block mt-1 w-full" type="email" name="email" placeholder="Email" :value="old('email')" required autocomplete="username" />
                    ...
                    <button type="submit" style="background:#3C413F ;" class="btn">Creat Account</button>
                    <div class="line">
                            <span></span>
                            <p>OR</p>
                            <span></span>
